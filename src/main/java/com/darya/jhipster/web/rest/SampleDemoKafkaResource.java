...
@RestController
@RequestMapping("/api/sample-demo-kafka")
public class SampleDemoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SampleDemoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SampleDemoKafkaResource(KafkaProperties kafkaProperties) {
